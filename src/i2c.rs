...
pub trait FCInstance: crate::flexcomm::I2cPeripheral {}
impl FCInstance for crate::peripherals::FLEXCOMM0 {}
impl FCInstance for crate::peripherals::FLEXCOMM1 {}
impl FCInstance for crate::peripherals::FLEXCOMM2 {}
impl FCInstance for crate::peripherals::FLEXCOMM3 {}
impl FCInstance for crate::peripherals::FLEXCOMM4 {}
impl FCInstance for crate::peripherals::FLEXCOMM5 {}
impl FCInstance for crate::peripherals::FLEXCOMM6 {}
impl FCInstance for crate::peripherals::FLEXCOMM7 {}

/// io configuration trait for easier configuration
pub trait SclPin<FCInstance>: Pin + sealed::Sealed + crate::Peripheral {
    /// convert the pin to appropriate function for SCL usage
    fn as_scl(&self, pull: crate::iopctl::Pull);
}

/// io configuration trait for easier configuration
pub trait SdaPin<FCInstance>: Pin + sealed::Sealed + crate::Peripheral {
...
pub struct I2cMaster<'a, FC: FCInstance> {
...
pub struct I2cSlave<'a, FC: FCInstance> {
    bus: crate::flexcomm::I2cBus<'a, FC>,
}
...
impl<'a, FC: FCInstance> I2cMasterBlockingErrorType for I2cMaster<'a, FC> {
    type Error = Error;
}

// implement generic i2c interface for peripheral master type
impl<'a, FC: FCInstance> I2cMasterBlocking for I2cMaster<'a, FC> {
...
impl<'a, FC: FCInstance> I2cSlave<'a, FC> {
    /// use flexcomm fc with Pins scl, sda as an I2C Master bus, configuring to speed and pull
    pub fn new(
        fc: impl FCInstance<P = FC> + 'a,
        scl: impl SclPin<FC>,
...
impl<'a, FC: FCInstance> I2cSlaveBlocking for I2cSlave<'a, FC> {
    fn block_until_addressed(&self) -> Result<()> {
        self.poll()?;
