...
use embassy_imxrt::pwm::{CTimerPwm, CentiPercent, Channel, MicroSeconds, SCTClockSource, SCTPwm};
use embassy_imxrt::timer::TimerChannelNum;
...
fn setup_gpio() {
    ...
    iopctl.pio0_31().modify(|_, w| {
        w.fsel()
            .function_4() // F4 = CTIMER4_MAT3
            .pupdena()
            .disabled()
            .pupdsel()
            .pull_down()
...
async fn main(_spawner: Spawner) {
    ...
    let mut ctimer = CTimerPwm::new(p.CTIMER4_COUNT_CHANNEL3, MicroSeconds(10_000));
    ...
    loop {
        ...
        //let duty_cycle = ctimer.get_duty(TimerChannelNum::Channel3);
